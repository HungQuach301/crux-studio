...
| `D-C07` | Lối đi nhanh `hotfix`: một `main` đỏ vì workflow không phải chờ 12 giờ, với sáu điều kiện máy khoá được | [`D-C07.md`](D-C07.md) |
| `D-C08` | Danh sách năm status check bắt buộc của ruleset `protect-main`, ghi lại vào nguồn thẩm quyền (`platform/P-006`) | [`D-C08.md`](D-C08.md) |
