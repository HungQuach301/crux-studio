...
`D-C01` và `D-C02` được ghi thẳng trong `CHARTER.md` từ trước khi có thư mục này. Chúng **không** được chép lại ở đây: một nội dung hai chỗ là một nội dung sẽ lệch. Từ `D-C06` trở đi, mỗi quyết định là một file.
