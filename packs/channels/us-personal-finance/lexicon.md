# 🤖 Từ điển kênh — `us-personal-finance`

> Chuyển từ `docs/spec/CRUX-REFERENCE-SPEC.md`, khối `channels/us-personal-finance/lexicon.md`
> (mục `T-002`). Nội dung nghiệp vụ giữ nguyên văn.
>
> Sàn "mỗi tập ít nhất ba mục" là hằng số của **thể loại**, không phải của kênh: nó nằm ở
> `packs/genres/data-explainer/format-spec.json`, khoá `limits.lexiconMin`. Câu dưới đây mô tả
> ràng buộc đó, không định nghĩa lại nó.
