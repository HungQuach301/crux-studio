# 🤖 Channel Bible — `us-personal-finance`

> Chuyển từ `docs/spec/CRUX-REFERENCE-SPEC.md`, phần **I · CHANNELS/US-PERSONAL-FINANCE**,
> khối `channels/us-personal-finance/channel-bible.md` (mục `T-002`). Phần đó **không** mang
> dấu ⚠️ Crux, nên là tham chiếu có hiệu lực sau khi chuyển đường dẫn. Nội dung nghiệp vụ giữ
> nguyên văn; chỉ đường dẫn được chuyển theo bảng ở đầu spec.
