...
> ⚠️ Một chỗ vòng phá thử bắt được, ghi lại vì nó đúng hình dạng nhóm **Z**: bản đầu của `parseStep0LogId` có **thêm** một phép kiểm ngày viết tay bên cạnh vòng ghép-lại. Hai bản luật cho một việc, và hậu quả đo được là vòng ghép-lại thành **mã chết** — xoá nó đi mà bộ test vẫn xanh 16/16. Nay chỉ còn một bản, và phép phá thử tương ứng đỏ 2 bài.
