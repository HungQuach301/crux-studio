...
- tiêu chí xong:
  ...
  - ✅ Ghi mã giả định vào các phần phụ thuộc: `.gitattributes` (chú thích đầu file, chỗ trước đây ghi "chưa được chứng minh"), `ops/known-failures.md` `KF-009`.
